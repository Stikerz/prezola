...
export class UserService {
  ...
  public register(user) {
    this.http.post(this.baseUrl + '/weddingshop/users/', JSON.stringify(user), this.httpOptions).subscribe(
      data1 => {
    ...
    public updateUser(data) {
        this.updateheader();
        this.http.put(this.baseUrl + '/weddingshop/users/' + this.userID.value + '/', JSON.stringify(data), this.httpOptionsToken).subscribe(
      data1 => {
      ...
      public getUser() {
        this.updateheader();
        this.http.get(this.baseUrl + '/weddingshop/users/' + this.userID.value + '/', this.httpOptionsToken).subscribe(
      data => {
        this.user.next(data);
      ...
      public deleteUser() {
        this.updateheader();
        this.http.delete(this.baseUrl + '/weddingshop/users/' + this.userID.value + '/', this.httpOptionsToken).subscribe(
      data => {
